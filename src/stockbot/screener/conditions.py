...
# 表示用の短いラベル（docs/SCREENER.md §2 の条件表と 1 対 1）。配信で「どの条件で
# 落ちたか」を出すために使う。判定には使わないので、ここを変えても結果は変わらない
CONDITION_LABELS = {
    "A1": "売買代金3億以上", "A2": "終値300円以上", "A3": "履歴250日以上",
    "A4": "5日以内に決算なし",
    "B1": "75日線>200日線", "B2": "200日線が上向き", "B3": "終値が200日線以上",
    "B4": "52週高値の25%以内",
    "C1": "深さ3〜8%", "C2": "前の押し安値を維持", "C3": "押し目2〜12日",
    "C4": "直近高値を未更新",
    "D1": "終値が5日線超え", "D2": "終値が前日高値超え", "D3": "押し安値から半値戻し",
    "D4": "5/25/75日線で反発",
    "E1": "相対力が上位10%でない", "E2": "5日線からの乖離2%以下", "E3": "押し安値から5日以内",
}
